...
/**
 * Activity to view the RSS Feeds.
 *
 * @author Riccardo De Zen
 */
public class FeedActivity extends AppCompatActivity {

    private FilterArrayList<FeedItem> ITEMS = new FilterArrayList<>();
    String data_path;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Initializing context and other data
        ...
        refreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (MyUtils.checkNetwork(context))
                    new FeedTask().execute(getString(R.string.URL_feed));
    ...
    private class MyRecyclerAdapter extends RecyclerView.Adapter<MyRecyclerAdapter.MyViewHolder> {
        public class MyViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bind(FeedItem item) {
                ...
                TextView textView_description =
                        (TextView) thisView.findViewById(R.id.feed_description);
                TextView textView_date = (TextView) thisView.findViewById(R.id.feed_date);
                textView_title.setText(thisItem.title);
                if (Build.VERSION.SDK_INT >= 24) {
                    textView_description.setText(Html.fromHtml(thisItem.description,
        ...
        public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
            ...
            //click effect for the list item.
    ...
    /**
     * Class defining a background task to download the feed web page to a file.
     */
    ...
    /**
     * Class defining the task to load the saved feeds into the list.
     */
    private class XMLloader extends AsyncTask<String, Integer, Void> {
        ...
        FilterArrayList<FeedItem> result = null;
        ...
        protected Void doInBackground(String... strings) {
            ...
            //se non esiste il file non è mai stata avviata l'attività con internet quindi non ho
            // dati
            try {
