...
public class CircolariActivity extends AppCompatActivity{
    ...
    private FilterList<Filterable> BACKUP = new FilterList<>();
    ...
    private class CircolariLoader extends AsyncTask<String, Integer, Void>{
        ...
        FilterList<Filterable> result = null;
        ...
        protected Void doInBackground(String... strings) {
            ...
            //se il file non è presente l'app non è mai stata avviata con internet quindi non ho dati
            try{
    ...
    public class MyRecyclerAdapter extends RecyclerView.Adapter<MyRecyclerAdapter.MyViewHolder>{
        public class MyViewHolder extends RecyclerView.ViewHolder{
            ...
            public void clear(){ thisView.removeAllViews(); }
        }

        @NonNull
        @Override
        public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View convertView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.circolari_intermedio, viewGroup, false);
    ...
    private SpannableString span(String s, String query){
        //NON so per certo che query sia contenuta in s perchè la sottolista ha più elementi
        ...
        if(found) ss.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.colorPrimary)), start_index, end_index, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        return ss;
    }
}